...
require 'write_xlsx'
# Open the CSV file
csv = Roo::CSV.new('IJE_File_Layouts_Version_2021_FHIR-2023-02-22-All-Combined.csv')
...
workbook = WriteXLSX.new('IJE_File_Layouts_Version_2021_FHIR-2023-02-22-All-Combined.xlsx')
